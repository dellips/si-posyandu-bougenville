<x-layout-admin>
    ...
    <section class="m-1 p-8 rounded-md">
      <div class="flex justify-between items-center mx-2 p-8 rounded-md bg-white">
        <span class="font-semibold text-lg uppercase text-green-600">{{ $title }}</span>
        <div class="relative">
      ...
      <section class="my-5 mx-2 p-8 rounded-md bg-white">
        <p class="font-semibold text-lg uppercase text-green-600">Data Kegiatan Posyandu</p>
      ...
      <section class="my-5 mx-2 p-8 rounded-md bg-white">
          <p class="font-semibold text-lg uppercase text-green-600">Data Pelayanan Posyandu</p>
          <table class="m-2 table-auto min-w-full border-collapse border border-slate-400 rounded-lg overflow-hidden shadow-lg items-center text-center">
            <thead class="bg-">
              <th class="border w-20 border-slate-300">No</th>
              <th class="border border-slate-300">NIK</th>
