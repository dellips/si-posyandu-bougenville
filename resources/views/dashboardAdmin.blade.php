<x-layout-admin>
    ...
    <section class="grid grid-cols-1 gap-8 p-4  justify-evenly lg:grid-cols-3 xl:grid-cols-3">
      <div class="flex item-center justify-between p-4 bg-white rounded-md">
        <div>
          <h6 class="text-sm font-medium tracking-wider text-gray-500 uppercase">Kader Posyandu</h6>
          <!--masukin jumlah-->
      ...
      <div class="flex item-center justify-between p-4 bg-white rounded-md">
        <div>
          <h6 class="text-sm font-medium tracking-wider text-gray-500 uppercase">Sasaran Posyandu</h6>
          <!--masukin jumlah-->
          <span class="font-semibold text-green-600">00</span>
        </div>
        <div>
      ...
      <div class="flex item-center justify-between p-4 bg-white rounded-md">
        <div>
          <h6 class="text-sm font-medium tracking-wider text-gray-500 uppercase">Kegiatan</h6>
          <!--masukin jumlah-->
          <span class="font-semibold text-green-600">00</span>
        </div>
        <div>
