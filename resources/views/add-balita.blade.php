<x-layout>
    ...
    <section class="m-1 p-8 rounded-md bg-white">
        ...
        <form action="/submit-form-bumil" method="POST" class="m-1 p-4">
            ...
            <div class="mb-4">
                <label for="nIbu" class="block text-gray-700 font-semibold mb-2">Nama Ibu</label>
                <select name="nIbu" id="nIbu" placeholder="Pilih Nama Ibu" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
